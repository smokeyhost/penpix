  ...
  if (!task) {
    return (
      <div className="w-full flex flex-col gap-4 p-10">
        ...
        <div className="bg-gray-200 rounded-lg animate-pulse h-24 w-full"></div>
        <div className="bg-gray-200 rounded-lg animate-pulse h-20 w-full"></div>
      </div>
    );
  }
    ...
    <div className="w-full flex flex-col gap-4">
      ...
      <div className="p-10 w-full flex flex-col-reverse lg:flex-row gap-6">
        <div className="lg:w-2/3">
          ...
          <p className="text-blue-500 underline italic cursor-pointer" onClick={() => downloadTemplate(taskId)}>
            Download Template
          </p>
  
          <div className="mb-4 mt-4 text-sm text-gray-600">
            <p>
              <strong>Note:</strong> Please ensure your file names follow this convention: <code>id_typeOfActivity[#itemNumber].png</code>. For example: <code>12345_{task.exam_type}[1].png</code>.
            </p>
          </div>
        ...
        <div className="lg:w-1/3 flex flex-col gap-6">
          {owner ? (
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <div className="flex items-center gap-4">
                {owner.profile_image_url ? (
                  <img src={owner.profile_image_url} alt="Profile" className="rounded-full w-16 h-16 object-cover" />
                ) : (
            ...
            <div className="animate-pulse bg-gray-200 p-6 rounded-lg h-24"></div>
          )}
          {classInfo ? (
            <div className="bg-gray-100 p-6 rounded-lg">
      ...
      {showInvalidFiles && (
        <InvalidFilesList invalidFiles={invalidFiles} onClose={closeInvalidFilesList} />
      )}
    </div>
  );
};
