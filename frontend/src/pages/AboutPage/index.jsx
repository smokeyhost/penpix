...
const AboutPage = () => {
  ...
  return (
    <div className="container mx-auto p-6 sm:px-4 md:px-6 lg:px-10">
      <h1 className="text-3xl sm:text-2xl md:text-3xl font-bold mb-6">About PenPix</h1>

      <nav className="mb-8">
        <ul className="flex flex-wrap sm:flex-col md:flex-row space-x-4">
      ...
      <section id="background" className="mb-8">
        <h2 className="text-2xl sm:text-xl font-semibold mb-4 flex items-center">
      ...
      <section id="user-guide" className="mb-8">
        ...
        <ol className="list-decimal list-inside mb-4">
          ...
          <li className="text-sm sm:text-base md:text-lg">Go to the Dashboard to view your tasks.</li>
          <li className="text-sm sm:text-base md:text-lg">Use the &quot;Create Task&quot; button to add new tasks.</li>
      ...
      <section id="limitations" className="mb-8">
        ...
        <p className="text-sm sm:text-base md:text-lg mb-2">While using PenPix, please note the following limitations:</p>
        <ul className="list-disc list-inside mb-4 text-sm sm:text-base md:text-lg">
        ...
        <p className="text-sm sm:text-base md:text-lg mb-2">For best results, follow these guidelines:</p>
        <ul className="list-disc list-inside mb-4 text-sm sm:text-base md:text-lg">
      ...
      <section id="issues" className="mb-8">
        ...
        <p className="text-sm sm:text-base md:text-lg mb-2">Here are some common issues and their solutions:</p>
        <div className="overflow-x-auto">

          <table className="table-auto w-full border-collapse border border-gray-300 text-sm sm:text-base md:text-lg">
            <thead>
